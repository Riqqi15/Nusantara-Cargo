      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 mb-24 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              Hubungi tim teknis dan operasional kami hari ini untuk mendiskusikan solusi logistik kargo presisi yang dirancang khusus untuk skala bisnis Anda.
            </motion.p>
            ...
            <form className="relative z-10 space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2">
                    <User className="w-4 h-4 text-sky-600" /> Nama Perusahaan / Individu
                  </label>
                  <input 
                    type="text" 
                    id="name" 
                    ...
                    placeholder="Contoh: PT. Nusantara Logistics"
                  />
                </div>
                <div>
                  <label htmlFor="email" className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2">
                    <AtSign className="w-4 h-4 text-sky-600" /> Alamat Email
                  </label>
                  <input 
                    type="email" 
                    id="email" 
              ...
              <div>
                <label htmlFor="cargoType" className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2">
                  <Package className="w-4 h-4 text-sky-600" /> Jenis Layanan
                </label>
                <div className="relative">
                  ...
                  >
                    <option value="domestik">Kargo Domestik Umum</option>
                    <option value="internasional">Kargo Internasional Ekspor/Impor</option>
                    <option value="oversized">Kargo Berat & Oversized</option>
                    <option value="charter">Charter Pesawat Penuh</option>
                  </select>
              ...
              <div>
                <label htmlFor="message" className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2">
                  <MessageSquare className="w-4 h-4 text-sky-600" /> Detail Pengiriman
                </label>
                <textarea 
                  id="message" 
                  rows={4}
                  ...
                  placeholder="Mohon deskripsikan rute, estimasi berat, dan detail operasional lainnya..."
                ></textarea>
              </div>
        ...
        <div className="pt-20 pb-20 border-t border-slate-800 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:pr-8">
            ...
            <p className="text-slate-400 font-light font-nunito leading-relaxed mb-8">
              Solusi kargo udara premium, cepat, dan aman untuk pengiriman logistik Nusantara & global.
            </p>
          </div>

          {/* Links 1 */}
          <div>
            <h4 className="text-white font-bold mb-6 tracking-wide">Layanan</h4>
            <ul className="space-y-4 font-nunito font-light text-slate-400">
              <li><a href="#" className="hover:text-sky-400 transition-colors">Kargo Domestik</a></li>
              <li><a href="#" className="hover:text-sky-400 transition-colors">Kargo Internasional</a></li>
              <li><a href="#" className="hover:text-sky-400 transition-colors">Kargo Berat & Oversized</a></li>
              <li><a href="#" className="hover:text-sky-400 transition-colors">Charter Pesawat</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 font-nunito font-light text-slate-400">
              ...
              <li><a href="#" className="hover:text-sky-400 transition-colors">Armada</a></li>
              <li><a href="#" className="hover:text-sky-400 transition-colors">Karir</a></li>
              <li><a href="#" className="hover:text-sky-400 transition-colors">Berita & Media</a></li>
            </ul>
          </div>

          {/* Office */}
          <div>
            <h4 className="text-white font-bold mb-6 tracking-wide">Kantor Pusat</h4>
            <ul className="space-y-5 font-nunito font-light text-slate-400">
              <li className="flex gap-4">
                <MapPin className="w-5 h-5 text-sky-500 shrink-0 mt-1" />
                <span className="leading-relaxed">Gedung Nusantara Tower Lt. 15<br />Jl. Jenderal Sudirman Kav. 1<br />Jakarta Pusat 10220</span>
              </li>
              <li className="flex items-center gap-4">
                <Clock3 className="w-5 h-5 text-sky-500 shrink-0" />
                <span>Operasional: 24/7 (Non-Stop)</span>
              </li>
            </ul>
          </div>
